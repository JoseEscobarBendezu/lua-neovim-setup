...
local enable_capabilities = function(client, formatting, diagnostic, rangformatting, watchedFiles)
  ...
  client.server_capabilities.workspace.didChangeWatchedFiles = watchedFiles or false
end
