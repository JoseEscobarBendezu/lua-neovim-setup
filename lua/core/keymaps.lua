...
keymaps.telescope = {
	["n"] = {
		...
		["gii"] = "<cmd>lua require('telescope.builtin').lsp_implementations()<CR>",
		["giv"] = "<cmd>vsplit<cr><cmd>lua require('telescope.builtin').lsp_implementations()<CR>",
		["gix"] = "<cmd>split<cr><cmd>lua require('telescope.builtin').lsp_implementations()<CR>",
		["gd"] = "<cmd>lua require('telescope.builtin').lsp_definitions()<CR>",
		["gv"] = "<cmd>vsplit<cr><cmd>lua require('telescope.builtin').lsp_definitions()<CR>",
		["gx"] = "<cmd>split<cr><cmd>lua require('telescope.builtin').lsp_definitions()<CR>",
